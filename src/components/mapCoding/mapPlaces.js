            ...
            <div className="restoLocate">
              <div className="restoBlock">
                <h6 className="ratingComm">
                  By clicking below, the app will access your location data to
                  give you a list of restaurants nearest to you
                </h6>
                <button onClick={checkAccess} type="button">
                  Ramen joints near me
                </button>
              </div>
              <div className="restoBlock">
                <h6 className="ratingComm">
                  If you would rather not give your location data, choose your
                  city and find your restaurant in the list
                </h6>
                ...
                <button onClick={() => handleSearch(userCity)} type="button">
                  GO
                </button>
              </div>
            </div>
