  ...
  function callback(results,status,pagination){
    ...
    if (status === 'OK') {
      for (let x of results){ // populate list of restos
        ...
        let resultRestos ={
          resto: x.name,
          latlng: {lat: x.geometry.location.lat(),lng:x.geometry.location.lng()},
          rating: x.rating,
          price: x.price_level,
...
//======  get geolocation of user =======
  ...
  const getCity = ((selection)=>{
    ...
    switch(city){
      case 'Montreal':
        userCity = {radius: 10000,lat: 45.5041905839693, lng:-73.57431928743786};
        break;
      case 'Toronto': 
        userCity = {radius: 10000,lat: 43.655739842049236, lng: -79.38374061036242};
        break;
      case 'Vancouver':
        userCity = {radius: 10000,lat: 49.280956827935505, lng:-123.12243738369997};
        break;
      case 'Ottawa':
        userCity = {radius: 10000,lat: 45.41982910818854, lng: -75.70019586916331};
        break;
      default:
