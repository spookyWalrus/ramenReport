...
export default function TheMap() {
  let pos = [{ lat: 45.5591827, lng: -73.7118733 }, "H2W 1V6"]; // default position value on first render
...
const Mappy = ({ coords }) => {
  ...
  return (
    <div>
      <div>
        <p>
          You are somewhere around this postal code:
          <span>
            <h4>{postal}</h4>
          </span>
        </p>
      </div>
      <GoogleMap zoom={10} center={lalo} mapContainerClassName="map-container">
