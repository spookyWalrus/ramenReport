...
export default function Report() {
  ...
  if (toppRate === 0) {
    ...
    toppCom =
      " I ate the toppings because I didn't want to waste my money, but I could've left them alone.";
  } else if (toppRate === 2) {
  ...
  if (expRate === 0) {
    ...
    expCom =
      " This is a true gem. I would rather not let anyone else know about this place because I want it all to myself.";
  }

  let reportdata = useActionData();

  useEffect(() => {
    // console.log("Render: report data is at: ", reportdata);
    if (reportdata != undefined) {
      alert(
        "You made a Ramen Report! You've now done " +
          reportdata.entries +
          " Ramen reports."
      );
      setUserStat(reportdata);
    } else if (reportdata === null || undefined) {
      reportdata = "";
    }
  }, [reportdata]);
          ...
          <Form method="post" action="/report">
            <div className="starBack">
              <div className="ratingLabel">
                ...
                <StarRating rate={rateNoodle} num={1}></StarRating>
            ...
            <div className="starBack">
              <div className="ratingLabel">
                ...
                <StarRating rate={rateSoup} num={2}></StarRating>
            ...
            <div className="starBack">
              <div className="ratingLabel">
                ...
                <StarRating rate={rateTopp} num={3}></StarRating>
            ...
            <div className="starBack">
              <div className="ratingLabel">
                ...
                <StarRating rate={rateExp} num={4}></StarRating>
            ...
            <div className="starBack">
              <div className="ratingLabel">
                ...
                <h6 className="ratingComm">
                  {" "}
                  What type of noodles? What was the soup? What were the
                  toppings? Oh man, what exactly did I just eat?{" "}
                </h6>
            ...
            <div className="starBack">
              <div className="ratingLabel">
                ...
                <h6 className="ratingComm">
                  Let us know what you liked or disliked about your meal. Be
